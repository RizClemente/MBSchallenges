...
resource "aws_security_group" "bastion_ssh_all_sg_rizza" {
    
    name            = "bastion_ssh_all_sg_rizza"
    description     = "Allow SSH from Anywhere"
    vpc_id          = aws_vpc.vpcrizza.id #module.site.output_vpc_id 
...
output "output_bastion_ssh" {
  value = aws_security_group.bastion_ssh_all_sg_rizza.id
}
...
resource "aws_security_group" "bastion_ssh_from_nat" {
    ...
    ingress {
     ...
     protocol        = "tcp"
     security_groups = [
                        aws_security_group.bastion_ssh_all_sg_rizza.id,
